...
| Question 1's illustration | A picture above every band is normally the organiser's masthead and is dropped. But question 1 has no question before it to catch a picture hanging above its own number, and these boxes hang far: one paper prints its first sum as a 286-unit box whose transparent top reaches over the masthead, putting its centre 39 units above the "1.". Told apart by the bottom edge — the masthead never reaches down past the first question's number, and that question's own artwork always does. |
